...
replace google.golang.org/genproto => google.golang.org/genproto/googleapis/api v0.0.0-20251103181224-f26f9409b101
...
require (
	...
	github.com/googleapis/googleapis v0.0.0-20251104043431-a0066e7bcf48 // indirect
